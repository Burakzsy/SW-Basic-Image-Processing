...
HD_PWD='C:/Users/Burak/Desktop/temel_imge_isleme/temel_imge_isleme/temel_imge_isleme.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log temel_imge_isleme.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source temel_imge_isleme.tcl
